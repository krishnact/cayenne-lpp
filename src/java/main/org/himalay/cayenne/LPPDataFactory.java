...
public class LPPDataFactory implements Factory {
	...
	public static LPPData createMsg(DataInputStream istream, AtomicInteger iHolder) throws IOException {
	...
	public static LPPData createMsg(org.himalay.cayenne.LPPHeader temp, DataInputStream dis, IntegerHolder iHolder)
			throws IOException {
		int iRead = 0;
		LPPData retVal = null;
		try {
