...
public class Presence_ extends LPPDataFactory.LPPData { // Concrete type is Presence
	...
	public Presence_() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x66);
	}
