...
public class Temperature_ extends LPPDataFactory.LPPData { // Concrete type is Temperature
	...
	public Temperature_() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x67);
	}
