...
public class AnalogOutput_ extends LPPDataFactory.LPPData { // Concrete type is AnalogOutput
	...
	public AnalogOutput_() // throws Exception
	{
		init();
	}
