...
public class DigitalInput_ extends LPPDataFactory.LPPData { // Concrete type is DigitalInput
	...
	public DigitalInput_() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x00);
	}
