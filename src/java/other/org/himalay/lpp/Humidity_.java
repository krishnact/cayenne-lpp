...
public class Humidity_ extends LPPDataFactory.LPPData { // Concrete type is Humidity
	...
	public Humidity_() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x68);
	}
