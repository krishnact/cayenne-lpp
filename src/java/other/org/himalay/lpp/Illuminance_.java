...
public class Illuminance_ extends LPPDataFactory.LPPData { // Concrete type is Illuminance
	...
	public Illuminance_() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x65);
	}
