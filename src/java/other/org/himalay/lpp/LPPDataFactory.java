...
public class LPPDataFactory implements Factory {
	...
	public static LPPData createMsg(DataInputStream istream, IntegerHolder iHolder1) throws IOException {
		int iRead = 0;
		LPPHeader header;
		{
			int retVal = 0;
	...
	public static LPPData createMsg(org.himalay.lpp.LPPHeader temp, DataInputStream dis, IntegerHolder iHolder)
			throws IOException {
		int iRead = 0;
		LPPData retVal = null;
		try {
	...
	public static abstract class LPPData extends BinMessage implements FactoryProduct {
		public LPPData() {
			super();
			// TODO Auto-generated constructor stub
		}

		public abstract void setHeader(org.himalay.lpp.LPPHeader header);

		public abstract org.himalay.lpp.LPPHeader getHeader();
